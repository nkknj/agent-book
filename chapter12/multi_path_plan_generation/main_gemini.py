...
from passive_goal_creator.main_gemini import Goal, PassiveGoalCreator
from prompt_optimizer.main_gemini import OptimizedGoal, PromptOptimizer
from pydantic import BaseModel, Field
from response_optimizer.main_gemini import ResponseOptimizer
...
class OptionPresenter:
    ...
    def run(self, task: Task) -> int:
        ...
        chain = (
            choice_prompt
            | self.llm.with_config(configurable=dict(max_output_tokens=1))
            | StrOutputParser()
        )
